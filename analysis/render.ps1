...
$maps=Get-Content analysis/maps.json -Raw | ConvertFrom-Json
...
$sheet.Save((Join-Path $pwd ('analysis/map_'+$mi+'.png')),[System.Drawing.Imaging.ImageFormat]::Png);$g.Dispose();$sheet.Dispose()
}
