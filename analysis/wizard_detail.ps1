...
$g.Dispose()
$ids=@{'#EE3020'=49;'#951D24'=49;'#EEE8D4'=0;'#FFFFFF'=0;'#C9C9C9'=18;'#151515'=129;'#777777'=18;'#3220D9'=82;'#542EFF'=82;'#21118F'=82;'#FFE35B'=0}
...
[IO.File]::WriteAllBytes((Join-Path $pwd '마법사_수작업도트_v5.LMF'),$out)
...
$canvas.Save((Join-Path $pwd 'analysis\마법사_수작업도트_v5.png'));$g.Dispose();$canvas.Dispose();foreach($t in $cache.Values){$t.Dispose()};"Saved $($rec.Count) blocks"
