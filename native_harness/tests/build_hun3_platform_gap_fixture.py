"""Build a disposable 훈3 variant with the middle platform shifted right one tile."""
from pathlib import Path
import struct

ROOT = Path(__file__).resolve().parents[1]
source = ROOT.parent / "훈련용맵" / "훈3.LMF"
target = ROOT / "tests" / "hun3_middle_platform_right_one.LMF"
